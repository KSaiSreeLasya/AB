...
class ServerGoogleSheetsService {
  ...
  private async initializeAuth() {
    try {
      ...
      // Try to initialize auth with service account JSON from environment variable first (for deployment)
      ...
      // Fallback to service account file (for local development)
        ...
        console.warn(
          "📋 Google Sheets service account not found (neither env var nor file). Google Sheets integration disabled.",
        );
        this.initialized = false;
        return;
      }
